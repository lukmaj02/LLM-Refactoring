...
def _handle_max_retry_error(e, request):
...
def _handle_ssl_http_error(e, request):
...
def send(
    ...
    try:
        ...
        _handle_max_retry_error(e, request)
    except ClosedPoolError as e:
        raise ConnectionError(e, request=request)
    except _ProxyError as e:
        raise ProxyError(e)
    except (_SSLError, _HTTPError) as e:
        _handle_ssl_http_error(e, request)
