...
def super_len(o):
    ...
    current_position = _get_current_position(o, total_length)
...
def _get_total_length(o):
    ...
    if hasattr(o, "fileno"):
        return _get_fileno_length(o)

    return None


def _get_fileno_length(o):
    try:
        fileno = o.fileno()
...
def _get_current_position(o, total_length):
    if hasattr(o, "tell"):
        try:
            ...
            return total_length if total_length is not None else 0
