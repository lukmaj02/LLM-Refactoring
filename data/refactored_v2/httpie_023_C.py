...
# condition: C
# timestamp: 2026-06-04T14:06:54
# original_cc: 7, original_mi: None
# changed_pct: 0.5000
# === END HEADER ===
def _get_total_size(self, final_response):
    try:
...
def _prepare_output_file(self, initial_url, final_response, total_size):
...
def start(
    ...
    total_size = self._prepare_output_file(initial_url, final_response, total_size)
