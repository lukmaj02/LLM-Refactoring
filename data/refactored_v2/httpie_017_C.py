...
def _append_argument_name(text, name, nargs, is_whitelisted):
...
def _append_argument_choices(text, argument):
...
def to_usage(
    ...
    *,
    ...
    for argument in shown_arguments:
        ...
        name = _get_argument_name(argument)
        nargs = argument.configuration.get('nargs')

        _append_argument_name(text, name, nargs, is_whitelisted)
        _append_argument_choices(text, argument)
